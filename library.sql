...
INSERT INTO `BookShelfs` VALUES (2,2,2,'2018-09-18 00:01:06','2018-09-18 00:01:06');
...
--
-- Table structure for table `LikedCommunityComment`
--

DROP TABLE IF EXISTS `LikedCommunityComment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `LikedCommunityComment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `cid` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  ...
  KEY `uid` (`uid`),
  KEY `cid` (`cid`),
  CONSTRAINT `likedcommunitycomment_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`id`),
  CONSTRAINT `likedcommunitycomment_ibfk_2` FOREIGN KEY (`cid`) REFERENCES `communitycomment` (`id`)
...
--
-- Table structure for table `UnlikedCommunityComment`
--

DROP TABLE IF EXISTS `UnlikedCommunityComment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `UnlikedCommunityComment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL,
  `cid` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  ...
  KEY `uid` (`uid`),
  KEY `cid` (`cid`),
  CONSTRAINT `unlikedcommunitycomment_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `user` (`id`),
  CONSTRAINT `unlikedcommunitycomment_ibfk_2` FOREIGN KEY (`cid`) REFERENCES `communitycomment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-09-27 20:36:55
